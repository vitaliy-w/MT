...
angular.module('mtApp').factory('angularShamInterceptor', [
...
angular.module('mtApp').factory('angularShamNotification', ['$rootScope', '$timeout', function ($rootScope, $timeout) {
 ...
 */
angular.module('mtApp').directive('shamSpinner', ['angularShamNotification', function (angularShamNotification) {
	return {
		restrict: "E",
